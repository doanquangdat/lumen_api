							...
							<td width="200" valign="top" align="center">
								<div class="contentEditableContainer contentImageEditable" >
			                        <div class="contentEditable" >
			                           <img src="/images/logo.png" width="155" height="155"  ata-default="placeholder" alt='Logo'/>
			                        </div>
			                    </div>
							</td>
							<td width="200" valign="top">&nbsp;</td>
					...
					<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
						...
						<tr>
							...
							<td width="500" align="center">
								<div class="contentEditableContainer contentTextEditable" >
			                        <div class="contentEditable" >
			                            <p >Blog updates for [DATE|0|F j, Y]</p>
			                        </div>
			                    </div>
							</td>
							<td width="50">&nbsp;</td>
						...
						<tr>
							...
							<td width="500" align="left" style="padding-bottom:15px;">
								<div class="contentEditableContainer contentTextEditable">
			                        <div class="contentEditable" >
			                            <p>
											[RSS=http://yourwebsite.com/blog/feed/]
											<strong>Check out the latest 3 posts from our blog</strong><br />
											<br />
											Post index '0' refers to the latest post, 1 to the second latest and so on. Change all the links : 'RSS=http://www.yourwebsite.com/blog/feed' for the URL of your blog's RSS feed.<br />
											<br />
											<strong><a target='_blank' href=”[RSS-0-link]”>[RSS-0-title]</a></strong><br />
											[RSS-0-description]
											[ENDRSS]
										</p>
			                        </div>
								...
								<div class="contentEditableContainer contentTextEditable">
			                        <div class="contentEditable" >
											<p>
												...
												<strong><a target='_blank' href=”[RSS-1-link]”>[RSS-1-title]</a></strong><br />
												[RSS-1-description]
												[ENDRSS]
											</p>
			                        </div>
							...
							<td width="500" align="left" style="padding-bottom:15px;">
								<div class="contentEditableContainer contentTextEditable">
			                        <div class="contentEditable" >
											<p>
												[RSS=http://www.yourwebsite.com/blog/feed/]
												<strong><a target='_blank' href=”[RSS-2-link]”>[RSS-2-title]</a></strong><br />
												[RSS-2-description]
												[ENDRSS]
											</p>
			                        </div>
					...
					<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
						<tr>
							...
							<td width="500"  align="center" style="padding-bottom:10px;padding-top:25px;">
								<div class="contentEditableContainer contentTextEditable" >
			                        <div class="contentEditable" style="color:#181818;font-family:Helvetica, Arial, sans-serif;font-size:22px;line-height: 20px;">
										<p style='color:#181818;'>All your emails should have a call to action</p>
			                        </div>
			                    </div>
							</td>
							<td width="50">&nbsp;</td>
						...
						<tr>
							...
							<td width="500" align="center" >
								<div class="contentEditableContainer contentTextEditable" >
			                        <div >
										<p>Have a clear action that your customers should take in every email you send - like "Read more" or "Visit our website" - even if you're just sending them a quick note to say "hi".</p>
			                        </div>
			                    </div>
										...
										<td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="400" height="50">
											<div class="contentEditableContainer contentTextEditable" >
						                        <div class="contentEditable" style='text-align:center;'>
						                            <a target='_blank' href="[CLIENTS.WEBSITE]" style="color:#fff;text-decoration:none;font-family:Helvetica, Arial, sans-serif;font-size:16px;color:#fff;border-radius:4px;">Read more</a>
						                        </div>
						                    </div>
										</td>
									</tr>
						...
						<tr>
							...
							<div class="contentEditableContainer contentTextEditable">
								<div class="contentEditable" >
									...
									<a target='_blank' href="[SHOWEMAIL]" style="text-decoration:none;color:#555">Open in your browser</a></span>
									<br>
									<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">
									<a target='_blank' href="[FORWARD]" style="text-decoration:none;color:#555">Foward to a friend</a></span>
									<br/>
									<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">
									...
									<tr>
										...
										<td valign="top" width='34'>
											<div class="contentEditableContainer contentTwitterEditable" style='display:inline;'>
						                      <div class="contentEditable" >
						                        <img src="images/twitter.png" data-default="placeholder" data-max-width="30" width='30' height='30' alt='twitter' style='margin-right:40x;'>
						                      </div>
						                    </div>
										</td>
										<td valign="top" width='34'>
											<div class="contentEditableContainer contentImageEditable" style='display:inline;'>
						                      <div class="contentEditable" >
						                        <a target='_blank' href="#" data-default="placeholder"  style="text-decoration:none;">
													<img src="images/pinterest.png" width="30" height="30" data-max-width="30" alt='Pinterest' style='margin-right:40x;' data-customIcon="true" />
												</a>
						                      </div>
						                    </div>
										</td>
